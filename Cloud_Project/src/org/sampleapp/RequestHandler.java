...
public class RequestHandler extends HttpServlet {
	...
	public void init() {
		...
		System.out.println("AppParameter.getTenantContextId() :" + AppParameter.getTenantContextId());
		System.out.println("AppParameter.getAppPrincipalId() :" + AppParameter.getAppPrincipalId());
		System.out.println("AppParameter.getSymmetricKey() :" + AppParameter.getSymmetricKey());
		System.out.println("AppParameter.getProtectedResourceHostName() :" + AppParameter.getProtectedResourceHostName());
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response){
		...
		response.setContentType("text/html");
		AppParameter.setTenantContextId(request.getParameter("tenant"));
		String uid = request.getParameter("DisplayName");
		String tenant = request.getParameter("tenant");
		String uname = request.getParameter("fn") + " " + request.getParameter("ln");
		System.out.println(request.getParameter("tenant"));
			...
			try{
				...
				case "createUser":
					...
					if (result.contains("odata.error")){
						...
						response.sendRedirect("MyCreateUser.jsp");
						return;
					}
					else
					{
					...
					response.sendRedirect("MyCreateUser.jsp");
						...
						{
							request.getSession().setAttribute("message", "Failed to insert data into database");
						}
